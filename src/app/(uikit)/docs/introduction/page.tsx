    ...
    return (
        <PageWrapper showRequirements={false} requirements={[]} title="Introduction">
            ...
            <div className="w-full flex flex-col gap-2">
                <h2 className="text-3xl font-semibold">What is FOUIKIT?</h2>
                <span className="text-pretty">
                    ...
                    <Link className="font-semibold underline" href="https://tailwindcss.com/" target="_blank">Tailwind CSS</Link>,&nbsp;
                    <Link className="font-semibold underline" href="https://motion.dev/" target="_blank">Framer Motion</Link>, and&nbsp;
                    <Link className="font-semibold underline" href="https://gsap.com/" target="_blank">GSAP</Link>.
                </span>
            </div>
