    ...
    return (
        <div className="w-full h-full flex flex-col gap-12 overflow-y-auto overflow-x-hidden pb-12 px-4">
            <div className="w-full h-fit flex flex-col gap-2">
                <Link href={'/utilities/dbSchemaGenerator'} className="hover:opacity-85">
                ...
                <Link href={'/utilities/dbSchemaGenerator'} className="w-full h-fit flex items-center justify-center mt-8 hover:opacity-85 cursor-pointer" >
                    <Image alt="Database generator" src={dbgen} width={600} height={300} />
                </Link>
                <Link href={'/utilities/dbSchemaGenerator'} className="underline flex flex-row gap-2 hover:opacity-85">Ir para aplicação <ArrowRight /></Link>
            </div>
