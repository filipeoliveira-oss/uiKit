...
import DataTable, { DataTableColumnDefinition } from "@/uiKit/components/dataTable/dataTable"

export default function DataTablePage() {

    const colDef:Array<DataTableColumnDefinition> = [
        {field:'id', filter:true,flex:1, floatingFilter:true,headerName:'ID', resizable:false},
        {field:'name', filter:true,flex:1, floatingFilter:true,headerName:'Nome', resizable:false},
    ]

    const data = [
        {id:1, name:'Primeiro nome'},
        {id:2, name:'Segundo nome'},
        {id:3, name:'Terceiro nome'},
        {id:4, name:'Quarto nome'},
    ]
...
export default memo(DataTable)`
    ...
    return (
        <PageComponent
            ...
            componentCodeName="DataTable"
            description="Wrapper do React AG Grid para exibição e manipulação de dados em formato de tabela. Esse é o único componente que você precisará instalar uma lib externa"
            code={code}
            preview={<DataTable columnDefs={colDef} rowData={data}/>}
            props={[
                {
                    propName: "rowData",
                    type: "Array<any>",
                    default: "-",
                    description: "Dados que serão exibidos na tabela",
                    required: true
                },
                {
                    propName: "columnDefs",
                    ...
                    default: "-",
                    description: "Definição das colunas e como os dados serão apresentados",
                    required: true
                },
                {
                    propName: "others",
                    type: "AG Grid Props",
                    default: "-",
                    description: "Todos os outros parâmetros seguem a documentação do React AG Grid",
                    required: false
                }
            ]}
        />
