...
`
    ...
    return (
        <PageComponent
            ...
            componentCodeName="Checkbox"
            description="Componente de checkbox customizado para seleção de estados booleanos com suporte a estilos e animações."
            code={code}
            preview={<Checkbox setValue={setValue} value={value}/>}
            props={[
                {
                    propName: "value",
                    type: "boolean",
                    default: "-",
                    description: "Valor atual do checkbox",
                    required: true
                },
                {
                    propName: "setValue",
                ...
                },
                {
                    ...
                    type: "'square' | 'rounded'",
                    default: "square",
                    description: "Formato visual do checkbox",
                    required: false
                },
                {
                    propName: "falseAccentColor",
                    type: "string",
                    default: "#FE0000",
                    description: "Cor aplicada quando o valor é falso",
                    required: false
                },
                {
                    propName: "trueAccentColor",
                    type: "string",
                    default: "#00CC44",
                    description: "Cor aplicada quando o valor é verdadeiro",
                    required: false
                },
                {
                    propName: "disabledAnimation",
                    type: "boolean",
                    default: "false",
                    description: "Desativa animações do componente",
                    required: false
                },
                {
                ...
                },
                {
                    ...
                    type: "number",
                    default: "32",
                    description: "Tamanho do checkbox em pixels",
                    required: false
                }
            ]}
        />
