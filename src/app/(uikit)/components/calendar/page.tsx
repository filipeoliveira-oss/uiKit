...
export default function Calendar({ disabled, label, labelClassname, language = 'pt-BR', setDate, date, showIcon, showButtonBar, showTime, timeFormat = '24', customLanguage, colors, timeOnly = false, dateTemplate, inline = false, view, format = 'dd/mm/yy', maxDate, minDate }: ICalendar) {
    ...
    return (
        <PageComponent
            ...
            componentCodeName="Calendar"
            description="Componente de calendário (DatePicker) usado para seleção de datas e horários."
            code={code}
            preview={<Calendar date={date} setDate={setDate}/>}
            props={[
                {
                    propName: "date",
                    type: "string",
                    default: "-",
                    description: "Data atualmente selecionada e exibida",
                    required: true
                },
                {
                    propName: "setDate",
                    ...
                    default: "-",
                    description: "Função para atualizar a data selecionada",
                    required: true
                },
                {
                    propName: "disabled",
                    type: "boolean",
                    default: "false",
                    description: "Desabilita interação com o componente",
                    required: false
                },
                {
                    propName: "label",
                ...
                },
                {
                    ...
                    type: "string",
                    default: "-",
                    description: "Classe CSS aplicada ao label",
                    required: false
                },
                {
                    propName: "language",
                    type: "string",
                    default: "pt-BR",
                    description: "Idioma usado no calendário (BCP 47)",
                    required: false
                },
                {
                    propName: "showIcon",
                    type: "boolean",
                    default: "false",
                    description: "Exibe um ícone de calendário no input",
                    required: false
                },
                {
                    propName: "showButtonBar",
                    type: "boolean",
                    default: "false",
                    description: "Exibe botões de ação (hoje e limpar)",
                    required: false
                },
                {
                    propName: "showTime",
                    type: "boolean",
                    default: "false",
                    description: "Habilita seleção de horário",
                    required: false
                },
                {
                    propName: "timeFormat",
                    type: "'12' | '24'",
                    default: "24",
                    description: "Formato do horário exibido",
                    required: false
                },
                {
                    propName: "timeOnly",
                    type: "boolean",
                    default: "false",
                    description: "Exibe apenas seleção de horário",
                    required: false
                },
                {
                    propName: "inline",
                    type: "boolean",
                    default: "false",
                    description: "Exibe o calendário inline ao invés de popup",
                    required: false
                },
                {
                    propName: "view",
                    type: "'month' | 'year'",
                    default: "-",
                    description: "Define visualização inicial do calendário",
                    required: false
                },
                {
                    propName: "format",
