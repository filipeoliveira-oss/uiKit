...
export const Tooltip = forwardRef<HTMLDivElement, TooltipType>(
    ...
    return (
        <PageComponent
            ...
            componentCodeName="tooltip"
            description="Componente de tooltip para exibir informações adicionais ao passar o mouse ou focar em um elemento, com suporte a posicionamento e delays configuráveis."
            code={code}
            preview={<Tooltip content="Eu sou uma tooltip">
            ...
            props={[
                {
                    ...
                    type: "string",
                    default: "-",
                    description: "Texto exibido dentro do tooltip",
                    required: true
                },
                {
                    propName: "placement",
                ...
                },
                {
                    ...
                    type: "number",
                    default: "150",
                    description: "Tempo (ms) para exibir o tooltip",
                    required: false
                },
                {
                    propName: "delayHide",
                    type: "number",
                    default: "150",
                    description: "Tempo (ms) para esconder o tooltip",
                    required: false
                },
                {
                    ...
                    type: "string",
                    default: "#ffffff",
                    description: "Cor de fundo do tooltip",
                    required: false
                },
                {
                    propName: "className",
                    type: "string",
                    default: "-",
                    description: "Classes adicionais aplicadas ao tooltip",
                    required: false
                }
            ]}
        />
