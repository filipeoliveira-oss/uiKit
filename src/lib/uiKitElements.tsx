...
export const componentsList = [
    ...
    { url: "/components/codeBlock", title: "Code Block", description: "Bloco formatado para exibição de código.", component: () => <Component strokeWidth={1.5} /> },
    ...
    { url: "/components/customDropdownFilter", title: "Custom Filter", description: "Filtro customizável com dropdown.", component: () => <Component strokeWidth={1.5} /> },
