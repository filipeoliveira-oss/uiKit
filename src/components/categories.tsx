...
const categories = [
  {
    icon: Layers,
    title: "Componentes",
    description: "Buttons, Cards, Modals, Forms e mais de 50 componentes prontos para usar.",
    count: 54,
    href: "/components",
  ...
  },
  {
    icon: Loader2,
    title: "Loaders",
    description: "Spinners, Skeletons, Progress bars e indicadores de carregamento animados.",
    count: 16,
    href: "/loaders",
