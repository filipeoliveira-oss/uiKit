...
export default function Footer() {
    return (
        <div className="w-full h-[50vh] flex items-center justify-center flex-col bg-background/50 mt-8">
            <div className="w-defaultWidth h-full flex flex-row justify-between items-center">
                ...
                <div className="w-fit h-fit flex flex-col gap-2">
                    <span className="font-bold mb-8">Get in touch</span>
                    <div className="flex flex-row w-fit h-fit gap-4">
                        <button className="p-2 border border-zinc-400 w-fit h-fit rounded-lg">
                            <Link href={'https://discord.com/users/350428533585346561'} target="_blank">
                                <svg width="24px" height="24px" viewBox="0 -28.5 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                                    <g>
                        ...
                        <button className="p-2 border border-zinc-400 w-fit h-fit rounded-lg">
                            <Link href={'https://www.linkedin.com/in/filipeoliveirasilva/'} target="_blank">
            ...
            <div className="w-defaultWidth h-fit flex flex-row items-center justify-center py-2">
                <span>Feito por Filipe Oliveira</span>
            </div>
        </div>
    )
}